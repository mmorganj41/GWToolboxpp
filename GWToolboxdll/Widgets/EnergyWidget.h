...
class EnergyWidget : public ToolboxWidget {
    EnergyWidget() = default;
...
public:
    static EnergyWidget& Instance()
    {
        static EnergyWidget instance;
        return instance;
    }

    [[nodiscard]] const char* Name() const override { return "Energy"; }
    ...
    bool click_to_print_energy = false;
